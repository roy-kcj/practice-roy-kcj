...
```{r}
rckhoo_ans = c('https://github.com/roy-kcj/practice-roy-kcj', 1, 'https://github.com/xuanwenloo/practice1-xuanwenloo', 1, 'https://github.com/xuanwenloo/practice1-xuanwenloo')

empty_ans = c('','','','','')


tab <- matrix(c(rckhoo_ans, empty_ans), ncol=5, byrow=TRUE)

colnames(tab) <- c('Repository Link', 'No. of Pull Req', 'Req Repo', 'No. of Pull Acpt', 'Acpt Repo')
rownames(tab) <- c('Roy Khoo', 'Empty')
tab
```
